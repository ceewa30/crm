<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="lname" class="block mt-1 w-full" type="text" name="last_name" :value="old('last_name')" required autofocus />
        ...
        <!-- First Name -->
        <div>
            <x-input-label for="fname" :value="__('Terms Accepted')" />
            <x-text-input id="fname" class="block mt-1" type="checkbox" name="terms_accepted" value="1" required autofocus />
