<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ request()->routeIs('clients.index') ? __('Client') : __('Trash') }}
        </h2>
    </x-slot>
                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    @if(request()->routeIs('clients.index'))
                        <a href="{{ route('clients.create') }}" class="btn-back btn-sm mb-2">+ New Client</a>
                    @endif
                      ...
                      <table class="min-w-full">
                        ...
                        <tbody>
                          <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ $client->company_address }}, {{ $client->company_city }}, {{ $client->company_state }}, {{ $client->company_zip }}
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                               <table>
                                <tr>
                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <a 
                                            ...
                                            {{-- @else
                                                href="{{ route('trashed.show', $client) }}" --}}
                                            {{-- @endif --}} alt="Show"
